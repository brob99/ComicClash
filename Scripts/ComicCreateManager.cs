...
public class ComicCreateManager : MonoBehaviour
{
    ...
    public GameObject confirmDialog;         // simple panel (Yes / No buttons call FinalSubmit / CancelConfirm)
    ...
    void PopulateCaptions()
    {
        ...
        // blacklist random 1/3 for variety
    ...
    public void FinalSubmit()
    {
        // store the comic
        ComicBank.AddComic(
            panels.Select(p => new ComicBank.Panel
            {
        ...
        // advance once everyone has submitted
